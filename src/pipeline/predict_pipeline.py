...
class PredictionPipeline:
    ...
    def get_predicted_dataframe(self,input_dataframe_path : pd.DataFrame):
        ...
        try:
            ...
            input_dataframe[prediction_col_name] = [pred for pred in predictions]

            target_column_mapping = {0 : 'bad' , 1 : 'good'}
            input_dataframe[prediction_col_name] = input_dataframe[prediction_col_name].map(target_column_mapping)
